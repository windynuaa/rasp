...
function get_info(){
    ...
    //disk1
    $D['disk2']['total'] = round(@disk_total_space("/home/pi/ntfs")/(1024*1024*1024),3);
    $D['disk2']['free'] = round(@disk_free_space("/home/pi/ntfs")/(1024*1024*1024),3);
    $D['disk2']['used'] = $D['disk2']['total'] - $D['disk2']['free'];
    $D['disk2']['percent'] = (floatval($D['disk2']['total'])!=0)?round($D['disk2']['used']/$D['disk2']['total']*100,2):0;
    //disk2
    $D['disk3']['total'] = round(@disk_total_space("/home/pi/ntfs2")/(1024*1024*1024),3);
    $D['disk3']['free'] = round(@disk_free_space("/home/pi/ntfs2")/(1024*1024*1024),3);
    $D['disk3']['used'] = $D['disk3']['total'] - $D['disk3']['free'];
    $D['disk3']['percent'] = (floatval($D['disk3']['total'])!=0)?round($D['disk3']['used']/$D['disk3']['total']*100,2):0;
